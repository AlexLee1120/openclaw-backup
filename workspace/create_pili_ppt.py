...
def create_pili_ppt(output_path):
    prs = Presentation()
    ...
    add_bullet_slide("d. 三年戰略規劃 (2028)", [
        "財務目標：營收突破 12 億台幣，EPS 重返 2.5 元以上。",
...
if __name__ == "__main__":
    path = sys.argv[1] if len(sys.argv) > 1 else "/Users/alex-ai/.openclaw/workspace/霹靂國際多媒體戰略分析簡報.pptx"
    create_pili_ppt(path)
